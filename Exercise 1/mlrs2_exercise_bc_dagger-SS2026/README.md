# MLRS2 Exercise - Imitation Learning with Behavioral Cloning and DAgger

In this exercise, you will implement behavioral cloning and DAgger to learn policies from expert demonstrations.
Instead of a human demonstrator, demonstrations will be provided via an expert policy that we have trained for you.
